      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Colors.purple.shade700, Colors.orangeAccent.shade700],
          ),
        ),
        child: Container(
              ...
              child: ListView(
                children: [
                          ...
                          setState(() {
                            switch (ex.code) {
                              case 'channel-error':
                                ...
                                break;
                              case 'invalid-email':
                                msgError = 'El correo ingresado no es válido';
                                break;
                  ...
                  Container(
                    ...
                    child: Text(msgError, style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize:18)),
                  ),
                ],
              ),
            ),
